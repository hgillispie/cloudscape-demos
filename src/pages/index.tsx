...
const demos = [
  ...
  { route: '/network-dashboard', title: 'Network Administration Dashboard', description: 'Network traffic monitoring and device management dashboard.', category: 'Dashboards' },
  {
    route: '/non-console',
  ...
  { route: '/weather-dashboard', title: 'Weather Dashboard', description: 'Weather forecast dashboard using Open-Meteo API.', category: 'Dashboards' },
