...
const demos = [
  ...
  { route: '/network-dashboard', title: 'Network Administration Dashboard', description: 'Network monitoring dashboard with traffic charts, device management, and system alerts.', category: 'Dashboards' },
  {
