...
const demos = [
  ...
  { route: '/network-dashboard', title: 'Network Administration Dashboard', description: 'Network Traffic, Credit Usage, and Your Devices monitoring dashboard.', category: 'Dashboards' },
  {
