...
const demos = [
  ...
  { route: '/network-dashboard', title: 'Network Administration Dashboard', description: 'Network traffic monitoring, credit usage tracking, and device management dashboard.', category: 'Dashboards' },
  {
