...
const demos = [
  ...
  { route: '/weather', title: 'Weather Dashboard', description: 'Real-time weather dashboard using Open-meteo API.', category: 'Dashboards' },
  { route: '/network', title: 'Network Administration Dashboard', description: 'Network traffic monitoring and device management dashboard.', category: 'Dashboards' },
];
