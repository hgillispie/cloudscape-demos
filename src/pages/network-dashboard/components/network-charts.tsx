  ...
  return (
    <Container header={<Box variant="h2">Network traffic</Box>}>
      <SpaceBetween size="m">
          ...
          >
            ...
            <svg width="100%" height="100%" viewBox="0 0 566 268" style={{ position: 'absolute' }}>
              ...
              <path
                ...
                fill="none"
              />
              <line x1="1" y1="150" x2="566" y2="150" stroke="#5F6B7A" strokeWidth="2" strokeDasharray="4 4" />
            </svg>
          </div>
        ...
        <Box textAlign="center" variant="h3" fontWeight="bold">
          Day
        </Box>
...
export function NetworkCharts() {
  return (
    <ColumnLayout columns={{ default: 1, s: 1, m: 2, l: 2, xl: 2 }} variant="text-grid">
      <NetworkTrafficChart />
      <CreditUsageChart />
    </ColumnLayout>
  );
